...
{
    public:
        static DampingBase* create_damping(const InvDiffKinSolverParams &params, const t_Matrix6Xd &jacobian_data);
...
{
    public:
        DampingNone(const InvDiffKinSolverParams &params, const t_Matrix6Xd &jacobian_data)
...
{
    public:
        DampingConstant(const InvDiffKinSolverParams &params, const t_Matrix6Xd &jacobian_data)
        : DampingBase(params, jacobian_data)
        {}
...
{
    public:
        DampingManipulability(const InvDiffKinSolverParams &params, const t_Matrix6Xd &jacobian_data)
        : DampingBase(params, jacobian_data)
        {}
...
{
    public:
        DampingLeastSingularValues(const InvDiffKinSolverParams &params, const t_Matrix6Xd &jacobian_data)
        : DampingBase(params, jacobian_data)
        {}
