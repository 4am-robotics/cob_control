 ...
 *
 * \brief
 *   Implementation of a factory to solve IK problems with JLA constraint.
 *
 ****************************************************************/
...
class WLN_JointLimitAvoidanceSolverFactory : public SolverFactory
{
    public:
        virtual ~WLN_JointLimitAvoidanceSolverFactory()
        {
        }
