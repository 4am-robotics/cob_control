...
#ifndef COB_TWIST_CONTROLLER_CONSTRAINT_SOLVERS_SOLVERS_WLN_SIGMOID2_JOINT_LIMIT_AVOIDANCE_SOLVER_H
#define COB_TWIST_CONTROLLER_CONSTRAINT_SOLVERS_SOLVERS_WLN_SIGMOID2_JOINT_LIMIT_AVOIDANCE_SOLVER_H
...
class WLN_Sigmoid2_JointLimitAvoidanceSolver : public WeightedLeastNormSolver
{
    public:
        WLN_Sigmoid2_JointLimitAvoidanceSolver(const TwistControllerParams& params,
                                      const LimiterParams& limiter_params,
                                      TaskStackController_t& task_stack_controller) :
                WeightedLeastNormSolver(params, limiter_params, task_stack_controller)
        {}

        virtual ~WLN_Sigmoid2_JointLimitAvoidanceSolver()
        {}
...
#endif  // COB_TWIST_CONTROLLER_CONSTRAINT_SOLVERS_SOLVERS_WLN_SIGMOID2_JOINT_LIMIT_AVOIDANCE_SOLVER_H
