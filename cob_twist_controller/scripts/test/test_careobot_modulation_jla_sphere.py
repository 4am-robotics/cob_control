...
def init_dyn_recfg():
    ...
    cli.set_config_param(tcc.SOLVER, tcc.TwistController_JLA_SIG_MODULATION)
...
if __name__ == "__main__":
    ...
    data_krakens = [
                    JointStateDataKraken(base_dir + 'joint_state_data_' + launch_time_stamp + 'SIG_MOD.csv'),
                    TwistDataKraken(base_dir + 'twist_data_' + launch_time_stamp + 'SIG_MOD.csv'),
                    JointVelocityDataKraken(base_dir + 'joint_vel_data_' + launch_time_stamp + 'SIG_MOD.csv'),
                    FrameTrackingDataKraken(base_dir + 'frame_tracking_data_' + launch_time_stamp + 'SIG_MOD.csv', root_frame, chain_tip_link, tracking_frame), ]
