 ...
 */
Eigen::MatrixXd ModulationSigmoidSolver::solve(const Vector6d_t& in_cart_velocities,
 ...
 */
Eigen::MatrixXd ModulationSigmoidSolver::calculateWeighting(Eigen::VectorXd q_dot, const JointStates& joint_states) const
{
